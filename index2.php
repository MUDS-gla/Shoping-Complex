...
<body>
    ...
    <div class="container">
                    ...
                    <div class="d-flex flex-column">
                        <div class="p-5 bg-dark text-white">
                            <div class="d-flex flex-row jistify-content-between align-item-center">
                                ...
                                <div class=logos ><a href="#" class="text-white"><i class="fab fa-facebook"></i></a></div>&emsp;&emsp;
                                <div class=logos ><a href="#" class="text-white"><i class="fab fa-instagram"></i></a></div>&emsp;&emsp;
                                <div class=logos ><a href="#" class="text-white"><i class="fab fa-twitter"></i></a> </div>&emsp;&emsp;
                                <div class=logos ><a href="#" class="text-white"><i class="fab fa-github"></i></a></div>&emsp;&emsp;
                        ...
                        <div class="p-5 text-white" style="background-color: black;">
                            ...
                            <p1>
                               ...
                               <p2>
                            &emsp; &emsp;
                            <a class=login href="select_login.php">Logout</a>
        ...
        <a class=shops href="#">Sports</a><br>
        <a class=shops href="#">Gym</a><br>
            </div>
