...
<body align="center">
    ...
    <form action="finalcustomermembership_renew1.php" method="post" onsubmit="return credit()">
...
<form action="finalcustomermembership_renew1.php" method="post">
...
$state=$_SESSION['state']; $photo=$_SESSION['photo'];$plus=$_SESSION['pluse'];*/

$plus_renew=$_POST['plus'];
$_SESSION['plus_renew']=$plus_renew;
