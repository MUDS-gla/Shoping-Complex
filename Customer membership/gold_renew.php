...
<body align="center">
    ...
    <form action="finalcustomermembership_renew2.php" method="post" onsubmit="return credit()">
    ...
    <form action="finalcustomermembership_renew2.php" method="post">
...
$gold_renew=$_POST['gold'];
$_SESSION['gold_renew']=$gold_renew;
