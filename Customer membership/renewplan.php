<html>
    ...
    <body>
        <h1><center>Membership Plans</center></h1>
        <table border="2" align="left" width="350" height="250">
            ...
            Renew your memberhip at:-<br>
            <h2><s> Rs.500</s></h2>
            <h2>Rs. 450</h2><br>
            <form method="post" action="plus_renew.php">
        ...
        <table border="2" align="center" width="350" height="250">
            ...
            <h2><s> Rs.1000</s></h2>
            <h2>Rs. 900</h2><br>
            <form method="post" action="gold_renew.php">
        ...
        <table border="2" align="right" width="350" height="250">
            ...
            <h2><s> Rs.2000</s></h2>
            <h2>Rs. 1800</h2><br>
            <form method="post" action="star_renew.php">
