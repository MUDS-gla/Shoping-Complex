...
<body align="center">
    ...
    <form action="finalcustomermembership3.php" method="post" onsubmit="return credit()">
    <table border=2 align="center" id="myTable1" style="width:50%" class="hidden">
        ...
        <tr>
            ...
            <td><input type="name" name="c3name" placeholder="Card owner name" required></td>
        </tr>
        <tr>
            <td>Card Number:</td>
            <td><input type="number" id="inumber" class="cnumber" name="f3number" placeholder="Enter card number" required></td>
        </tr>
        <tr>
            <td>Expiration Date:</td>
            <td><input type="number" id="im" class="cm" name="f3m" placeholder="MM" required><br>
                <input type="number" id="iy" class="cy" name="f3y" placeholder="YYYY" required></td>
        </tr>
        <tr>
            <td>CVV:</td>
            <td><input type="number" id="icvv" class="cvv" name="f3cvv" required></td>
        </tr>
    ...
    <form action="finalcustomermembership3.php" method="post">
